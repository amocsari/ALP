...
namespace ALP.Service
{
    public class InventoryApiService: IInventoryApiService
    {
        ...
        public async Task<List<string>> FindFilteredItemsAsStringForDisplay(InventoryItemFilterInfo info)
        {
            return await _apiService.PostAsync<InventoryItemFilterInfo, List<string>>("Item/FindItemsForDisplay", info);
        }
